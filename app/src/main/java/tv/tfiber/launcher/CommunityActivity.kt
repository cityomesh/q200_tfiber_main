...
class CommunityActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rightIcons = listOf(
            IconItem(R.drawable.yuvavikasamscheme, "", packageName="tgobmms.cgg.gov.in"),
            IconItem(R.drawable.sannabiyyamscheme, "", url="https://hyderabad.telangana.gov.in/scheme/rice-distribution/"),
            IconItem(R.drawable.indirammaatmiyabharosascheme, "", url = "https://www.telangana.gov.in/services/state-services/"),
            IconItem(R.drawable.factcheck, "", url = "https://www.telangana.gov.in/services/state-services/")
        )
